...
# SAVE page ---------------------------------------------------------------------
        ...
        self.fileSaveAsDialog.fileFolderNavigator.controlGo.style.update({'height':'30px', 'font-size':'12px'})
        self.fileSaveAsDialog.fileFolderNavigator.pathEditor.style.update({'padding-left':'5px', 'font-size':'12px', 'line-height':'2'})
        self.fileSaveAsDialog.fileFolderNavigator.itemContainer.style.update({'font-size':'20px'})
        self.fileSaveAsDialog.fileFolderNavigator.style.update({'width':'100%'})
        ...
        self.schedSaveAsDialog.fileFolderNavigator.controlBack.style.update({'height':'30px', 'font-size':'15px'})
        self.schedSaveAsDialog.fileFolderNavigator.controlGo.style.update({'height':'30px', 'font-size':'12px'})
        self.schedSaveAsDialog.fileFolderNavigator.pathEditor.style.update({'padding-left':'5px', 'font-size':'12px', 'line-height':'2'})
        self.schedSaveAsDialog.fileFolderNavigator.itemContainer.style.update({'font-size':'20px'})
        self.schedSaveAsDialog.fileFolderNavigator.style.update({'width':'100%'})
...
# Parameters references:
    ...
    def open_fileselection_dialog(self, widget, message, mult_select, file_select, fold_select, chiamata):
        ...
        self.fileselectionDialog.fileFolderNavigator.controlGo.style.update({'height':'30px', 'font-size':'12px'})
